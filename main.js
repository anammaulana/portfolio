...
const translations = {
  id: {
    ...
    cases: [
      ['Merancang lingkungan privat yang aman untuk menjalankan workload aplikasi, data, monitoring, dan AI tanpa mengganggu sistem produksi.', 'Menyusun topologi dua node, pembagian workload, spesifikasi hardware, lapisan virtualisasi, serta service yang akan dijalankan.', 'Proxmox, Windows 11 VM, Ubuntu, Docker, Kafka, Redis, PostgreSQL, monitoring, Ollama, embeddings, dan vector database.', 'Architecture draft telah terdokumentasi dan menjadi acuan untuk tahap pengadaan perangkat, implementasi, serta pengujian bertahap.'],
    ...
    values: [
      ...
      ['.project:nth-child(1) .project-description', 'Rancangan private infrastructure dua node untuk virtualisasi, data services, observability, aplikasi, dan eksperimen AI lokal.'], ['.project:nth-child(2) .project-description', 'Konsep pemantauan health, resource, log, dan availability untuk mendeteksi masalah sebelum berdampak ke pengguna.'], ['.project:nth-child(3) .project-description', 'Visualisasi aplikasi responsif untuk merangkum percakapan, performa tim, dan insight pelayanan dalam satu tampilan.'],
  ...
  en: {
    ...
    cases: [
      ['Design a secure private environment for application, data, monitoring, and AI workloads without affecting production systems.', 'Defined the two-node topology, workload allocation, hardware specifications, virtualization layer, and planned services.', 'Proxmox, Windows 11 VM, Ubuntu, Docker, Kafka, Redis, PostgreSQL, monitoring, Ollama, embeddings, and a vector database.', 'The architecture draft is documented and ready to guide hardware procurement, implementation, and incremental testing.'],
    ...
    values: [
      ...
      ['.project:nth-child(1) .project-description', 'A two-node private infrastructure design for virtualization, data services, observability, applications, and local AI experiments.'], ['.project:nth-child(2) .project-description', 'A monitoring concept covering health, resources, logs, and availability to catch issues before users are affected.'], ['.project:nth-child(3) .project-description', 'A responsive application concept bringing conversations, team performance, and service insights into one interface.'],
